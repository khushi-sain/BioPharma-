    ...
    <div id="loginModal" class="modal fixed inset-0 z-[110] items-center justify-center p-4">
        <div class="bg-white w-full max-w-md rounded-[2.5rem] p-10 shadow-2xl relative border border-slate-100 text-center">
            ...
            <form action="auth.php" method="POST" class="space-y-4">
                <input type="email" name="email" required placeholder="Email ID" class="w-full bg-slate-50 border-none rounded-2xl py-4 px-6 focus:ring-2 focus:ring-emerald-500 transition text-sm">
                <input type="password" name="password" required placeholder="Password" class="w-full bg-slate-50 border-none rounded-2xl py-4 px-6 focus:ring-2 focus:ring-emerald-500 transition text-sm">
                <button type="submit" class="w-full bg-emerald-600 text-white py-4 rounded-2xl font-bold shadow-xl mt-4 hover:bg-emerald-700 transition text-sm">Login</button>
            </form>
        </div>
    </div>
  ...
  <header class="glass-nav border-b border-slate-200 sticky top-0 z-40 px-8 py-4 flex justify-between items-center shadow-sm">
                ...
                <div class="relative z-50">
                    ...
                    <div id="profileDropdown" class="profile-dropdown absolute right-0 top-[115%] w-72 bg-white/95 backdrop-blur-2xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] rounded-[2rem] p-3 text-slate-800 border border-slate-100">
                        ...
                        <div class="py-1 space-y-1">
                            <a href="orders.php" class="block px-5 py-3 hover:bg-emerald-50/80 rounded-xl text-slate-600 hover:text-emerald-800 font-bold text-sm transition-all hover:translate-x-1">
                                Order History
                            </a>
                            <a href="addresses.php" class="block px-5 py-3 hover:bg-emerald-50/80 rounded-xl text-slate-600 hover:text-emerald-800 font-bold text-sm transition-all hover:translate-x-1">
                                My Addresses
                            </a>
                            <a href="reviews.php" class="block px-5 py-3 hover:bg-emerald-50/80 rounded-xl text-slate-600 hover:text-emerald-800 font-bold text-sm transition-all hover:translate-x-1">
                                Customer Reviews
                            </a>
                            <a href="help.php" class="block px-5 py-3 hover:bg-emerald-50/80 rounded-xl text-slate-600 hover:text-emerald-800 font-bold text-sm transition-all hover:translate-x-1">
                                Help & Support
                            </a>
                            <a href="logout.php" class="block px-5 py-3 hover:bg-rose-50 rounded-xl text-slate-600 hover:text-rose-600 font-bold text-sm transition-all hover:translate-x-1">
                                Sign Out
                            </a>
                        </div>
                    </div>
    ...
    <main class="p-8 max-w-[1400px] mx-auto w-full">
        ...
        <div class="mb-20 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-12 mt-12">
                <div class="flex flex-col items-center max-w-[200px]">
                    ...
                    <h4 class="font-bold text-slate-800 mb-2 text-sm">Pick Specialty</h4>
                ...
                <div class="flex flex-col items-center max-w-[200px]">
                    ...
                    <h4 class="font-bold text-slate-800 mb-2 text-sm">Choose Doctor</h4>
                ...
                <div class="flex flex-col items-center max-w-[200px]">
                    ...
                    <h4 class="font-bold text-slate-800 mb-2 text-sm">Visit Clinic</h4>
        ...
        <div class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-xl hover:border-emerald-300 transition-all text-center group cursor-pointer">
                    ...
                    <p class="text-slate-400 font-medium mb-10 leading-relaxed text-sm"><?php echo $s[1]; ?></p>
                    <button class="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-emerald-600 transition shadow-lg shadow-slate-200 active:scale-95 text-xs">Book Specialist</button>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto mb-20 text-center">
            <h2 class="text-2xl font-black text-slate-800 mb-8 tracking-tight">Frequently Asked Questions</h2>
            <div class="space-y-4">
